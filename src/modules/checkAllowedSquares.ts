...
class checkAllowedSquares {
    ...
    //1方向のみの検索
    private static checkOneDirection(square: Square | null, direction: string, playerColor: string): void {
        ...
        switch(direction){
            ...
            //もし合致する色がないときはメッセージ
            default: console.log("The direction should be in Config.direction.")
        }
    ...
    public static isSkipped(): boolean {
        for(let key in this.allDirections){
